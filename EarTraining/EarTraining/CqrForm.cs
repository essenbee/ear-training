...
{
    public partial class CqrForm : Form
    {
        // Private Variables
        // =================
        ...
        // Private Constants
        // =================
        private const string BeginnerText1 = "Placeholder for Stages 2 - 4";
        ...
        public CqrForm()
        {
            ...
            stage2RadioButton.Checked = true;
            _currentStage = 2;
            chordPaletteLabel.Text = GetChordQualities(_chordPalette);
        ...
        private void play_Click(object sender, EventArgs e)
        {
            ...
            {
                logger.Error(ex, "CqrForm.play_Click() :: EXCEPTION - ");
            }
        }
        ...
        private void repeat_Click(object sender, EventArgs e)
        {
            ...
            {
                logger.Error(ex, "CqrForm.repeat_Click() :: EXCEPTION - ");
            }
        }

        private void reveal_Click(object sender, EventArgs e)
        {
            answer.Text = $"{_prevQuestion.Quality.Description()} ({_prevQuestion.Name})";
        }

        private void stage1RadioButton_CheckedChanged(object sender, EventArgs e)
        {
            if (stage1RadioButton.Checked && interRadioButton.Checked)
            {
                _chordPalette = ChordLibrary.Stage1ChordPalette;
                InitialiseQuestion(1);
        ...
        private void stage4RadioButton_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                _chordPalette = ChordLibrary.Stage4ChordPalleteModified;
        ...
        private void stage5RadioButton_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                _chordPalette = ChordLibrary.Stage5ChordPaletteModified;
        ...
        private string GetChordQuality(Chord chord)
        {
            return chord.Quality.Description();
        }

        private string GetChordQualities(IEnumerable<Chord> chords)
        {
            var chordQualities = string.Empty;
            var qualities = chords.Select(chord => chord.Quality.Description()).ToList();
            var uniqueQualities = qualities.Distinct().ToList();
            chordQualities = uniqueQualities.Aggregate(chordQualities, (current, quality) => current + (quality + ", "));
            chordQualities = chordQualities.Remove(chordQualities.Length - 2, 2);
